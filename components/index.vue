      ...
      <div class="content">
        ...
        <div class="nav-u">
          <ul>
            ...
            <nuxt-link to="/tools" tag="li">
              <i class="iconfont icon-gongju"></i>
              站长工具
            </nuxt-link>

            <nuxt-link to="/note" tag="li">
              <i class="iconfont icon-biji"></i>
              个人笔记
            </nuxt-link>
           <nuxt-link to="/whisper" tag="li">
        ...
        <div class="login">
          ...
          <div style="display: inline-block" v-if="userInfo == null || !userInfo">
            ...
            <nuxt-link to="/login/register"><el-button type="primary" round>我要注册</el-button></nuxt-link>
          </div>
