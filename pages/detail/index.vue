    ...
    <section class="article-focusbox">
      ...
      <header class="article-header">
        ...
        <div class="article-meta">
          ...
          <span class="item item-5"><a id="ae_bdcx" rel="external nofollow" target="_blank" :href="detail.included"
                                       style="color: rgb(255, 0, 0);">提交收录</a></span>
        </div>
      </header>
    </section>
    ...
    <div class="content">
      <div class="left">
        ...
        <div class="content-b">
          ...
          <div>
            版权声明：文章为《
            <a href="javascript:void (0)" @click="authorDetail(detail.author)">{{ detail.author }}</a>
            》原创，转载请保留出处！
          </div>
        </div>
...
<script>
    ...
    import {random_photo, updateTitle, loadScript} from '~/utils/index';
